...
public class PauseMenu : MonoBehaviour
{
    ...
    public PauseMenuPositioner menuPositioner;          // Positions the menu in front of the player's view
    ...
    private void Start()
    {
        ...
        _menuButtonAction.performed += TogglePauseMenu;
    ...
    public void TogglePauseMenu(InputAction.CallbackContext context)
    {
        ...
        bool isPauseMenuVisible = !pauseMenuCanvas.enabled;
        pauseMenuCanvas.enabled = isPauseMenuVisible;
        ...
        Time.timeScale = isPauseMenuVisible ? 0f : 1f;
    }
    ...
    public void ToggleSettings()
    {
        ...
        pauseMenuCanvas.enabled = !settingsCanvas.enabled;
    }
    ...
    {
        Debug.Log("End assessment button pressed from PauseMenu.");

...
public class TaskTransitionManager2 : MonoBehaviour
{
    ...
    void Awake()
    {
        Debug.Log("[TaskTransitionManager2] Awake called.");
    ...
    void Start()
    {
        Debug.Log("[TaskTransitionManager2] Start called.");
    ...
    {
        Debug.Log("[TaskTransitionManager2] StartIntroductionTransition() called.");
        StartCoroutine(TransitionRoutine(introductionNPC, introductionTeleport));
    }

    public void StartTask1Transition()
    {
        Debug.Log("[TaskTransitionManager2] StartTask1Transition() called.");
    ...
    {
        Debug.Log("[TaskTransitionManager2] StartTask2Transition() called.");
        StartCoroutine(TransitionRoutine(task2NPC, task2Teleport));
    }

    public void StartTask3Transition()
    {
        Debug.Log("[TaskTransitionManager2] StartTask3Transition() called.");
    ...
    {
        Debug.Log("[TaskTransitionManager2] StartEndingTransition() called.");
        if (endingObject != null)
        {
            endingObject.SetActive(true);
            Debug.Log("[TaskTransitionManager2] Ending object activated.");
        }
        else
        {
            Debug.LogWarning("[TaskTransitionManager2] Ending object is not assigned!");
        }
        if (leftHandRayInteractor != null)
        {
            leftHandRayInteractor.gameObject.SetActive(true);
            Debug.Log("[TaskTransitionManager2] Left hand ray interactor activated.");
        }
        else
        {
            Debug.LogWarning("[TaskTransitionManager2] Left hand ray interactor is not assigned!");
        }
        if (rightHandRayInteractor != null)
        {
            rightHandRayInteractor.gameObject.SetActive(true);
            Debug.Log("[TaskTransitionManager2] Right hand ray interactor activated.");
        }
        else
        {
            Debug.LogWarning("[TaskTransitionManager2] Right hand ray interactor is not assigned!");
        }
    ...
    {
        Debug.Log("[TaskTransitionManager2] PostTask1Transition() called.");
    ...
    {
        Debug.Log("[TaskTransitionManager2] PostTask2Transition() called.");
    ...
    {
        Debug.Log("[TaskTransitionManager2] PostTask3Transition() called.");

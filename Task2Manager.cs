...
public class Task2Manager : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log("Initializing Task2Manager...");
    ...
    void Update()
    {
        ...
        if (taskManagerController.IsCurrentTask(this.gameObject) && !taskToggle.gameObject.activeSelf)
        {
    ...
    public void CompleteTask()
    {
        ...
        if (!taskCompleted && taskManagerController.IsCurrentTask(this.gameObject))
        {
            taskCompleted = true;
            ...
            taskManagerController.CompleteTask(); // Notify controller that a task is completed
        }
        else
        {
    ...
    public void UpdateHeader() // Change this method to public
    {
        ...
        Debug.Log($"Is Current Task: {taskManagerController.IsCurrentTask(this.gameObject)}");
